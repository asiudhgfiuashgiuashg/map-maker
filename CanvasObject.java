...
public class CanvasObject extends Canvas {
		...
		this.setOnMouseDragged(new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent event) {
				if (event.getButton() == MouseButton.PRIMARY) {
					...
					event.consume(); //stop the event from bubbling up to parent scrollpane
				}
			}
		});
		...
		this.setOnMouseClicked(new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent event) {
				...
				if (event.getButton() == MouseButton.SECONDARY) {
					...
					CanvasObject.canvasObjects.remove(CanvasObject.this);
					event.consume(); //stop the event from bubbling up to parent scrollpane
				}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CanvasObject)) {
			return false;
		}
		CanvasObject theOther = (CanvasObject) other;
		return theOther.getUID().equals(this.getUID());
	}
